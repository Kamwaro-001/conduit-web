    ...
    <div class="flex items-center gap-3">
      <div class="flex items-center gap-2 border-r border-slate-700 pr-3">
        ...
        <button
          ...
          @click="workflowStore.discardUnsavedChanges()"
          class="flex items-center gap-1 px-3 py-1.5 rounded transition-colors bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 border border-rose-500/20"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
